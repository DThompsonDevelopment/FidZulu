...
export class FidzulaService {
  ...
  public getTeam(type:string) : Observable<Team> {
    switch(type) {
      ...
      case 'food': return this.http.get<Team>(this.food + "team").pipe(catchError(this.handleError));
      case 'toy': return this.http.get<Team>(this.toys + "team").pipe(catchError(this.handleError));
      case 'book': return this.http.get<Team>(this.books + "team").pipe(catchError(this.handleError));
      case 'dvd': return this.http.get<Team>(this.dvds + "team").pipe(catchError(this.handleError));
      case 'laptop': return this.http.get<Team>(this.laptops + "team").pipe(catchError(this.handleError));
      default: throw new Error("Undefined team...");
    }
  }
