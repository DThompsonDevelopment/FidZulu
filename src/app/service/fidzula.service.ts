...
export class FidzulaService {
  ...
  public getBikesWithTeam() : Observable<Team> {
    return this.http.get<Team>(this.bikes + "team").pipe(catchError(this.handleError));
  }
  ...
  public getFoodWithTeam() : Observable<Team> {
    return this.http.get<Team>(this.food + "team").pipe(catchError(this.handleError));
  }
  ...
  public getToyWithTeam() : Observable<Team> {
    return this.http.get<Team>(this.toys + "team").pipe(catchError(this.handleError));
  }
  ...
  public getBookWithTeam() : Observable<Team> {
    return this.http.get<Team>(this.books + "team").pipe(catchError(this.handleError));
  }
  ...
  public getDvdWithTeam() : Observable<Team> {
    return this.http.get<Team>(this.dvds + "team").pipe(catchError(this.handleError));
  }
  ...
  public getLaptopWithTeam() : Observable<Team> {
    return this.http.get<Team>(this.laptops + "team").pipe(catchError(this.handleError));
  }
